...
def do_prediction(image,net,LABELS):
    ...
    if len(idxs) > 0:
        ...
        for i in idxs.flatten():
            response_array.append((LABELS[classIDs[i]],confidences[i],boxes[i][0], boxes[i][1],boxes[i][2],boxes[i][3]))
...
def main(arg1, arg2):
    ...
    labelsPath = "/usr/src/app/yolo_tiny_configs/coco.names"
    cfgpath = "/usr/src/app/yolo_tiny_configs/yolov3-tiny.cfg"
    wpath = "/usr/src/app/yolo_tiny_configs/yolov3-tiny.weights"
